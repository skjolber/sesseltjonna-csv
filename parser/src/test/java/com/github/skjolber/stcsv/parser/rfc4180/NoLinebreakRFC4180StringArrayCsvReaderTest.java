...
public class NoLinebreakRFC4180StringArrayCsvReaderTest extends AbstractCsvTest {
	...
	public void compareToConventionalParserWithoutQuotes() throws Exception {
		...
		NoLinebreakRFC4180StringArrayCsvReader factory = parser(file, StandardCharsets.UTF_8, false);
	...
	public void compareToConventionalParserWithoutQuotesAndCarriageReturn() throws Exception {
		...
		NoLinebreakRFC4180StringArrayCsvReader factory = parser(file, StandardCharsets.UTF_8, true);
	...
	public void compareToConventionalParserWithQuotes() throws Exception {
		...
		NoLinebreakRFC4180StringArrayCsvReader factory = parser(quotedFile, StandardCharsets.UTF_8, false);
	...
	public void compareToConventionalParserQuotesAndCarriageReturn() throws Exception {
		...
		NoLinebreakRFC4180StringArrayCsvReader factory = parser(quotedFile, StandardCharsets.UTF_8, true);
	...
	public void throwsExceptionOnIncorrectColumns() throws Exception {
		String input = "a,b,c\n";
		NoLinebreakRFC4180StringArrayCsvReader reader = new NoLinebreakRFC4180StringArrayCsvReader(new StringReader(input), 5);
	...
	public NoLinebreakRFC4180StringArrayCsvReader parser(File file, Charset charset, boolean crnl) throws Exception {
		...
		return new NoLinebreakRFC4180StringArrayCsvReader(reader, 7);
	}		
